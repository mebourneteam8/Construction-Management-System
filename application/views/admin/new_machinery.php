...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 <!-- Basic Page Needs
 ================================================== -->
 <title><?=$this->user_model->sitename?> :  New Machinery </title>
 <meta charset="utf-8">
  ...
  ================================================== -->
    ...
    <div id="titlebar">
      <div class="col-md-10 col-md-offset-1">
          <h2><b> <i class="fa fa-edit"></i> New Machinery </b></h2>
          <!-- Breadcrumbs -->
          <nav id="breadcrumbs">
    ...
    <?=$this->session->flashdata('messagePr')?>
                    ...
                    <div class="add-listing-section">
                      ...
                      <div class="add-listing-headline">
                        <h3><i class="list-box-icon im im-icon-cube"></i> New Machinery Details</h3>
                      </div>

                      <!-- Row -->
                      <form method="post" action="<?=base_url()?>admin/new_machinery_sub" enctype="multipart/form-data">
                      <div class="row with-forms">
                        <div class="col-md-12">
                              <h5><b> Name of the Machinery: * </b></h5>
                              <input type="Text" name="machinery_name" required value="" />
                        </div>
                      </div>
                          ...
                          <div class="row with-forms">                                
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" name="owner" required  value=""/>
                                  </div>
                           </div>
                          ...
                          <div class="row with-forms">                                
                                  <div class="col-md-6">
                                    <h5><b>Client :  *</b></h5>
                                    <input type="text" name="client" required  value=""/>
                                  </div>
                                  <div class="col-md-6">
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          ...
                                          <input type="text" name="monthly_emi" required  value=""/>
                                        </div>
                                        <div class="col-md-6">
                                          <h5><b>Place of Deployment: *</b></h5>
                                          <input type="text" name="place_of_deployment" required  value=""/>
                                        </div>
                                  </div>                 
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          ...
                                          <input type="date" name="rental_st_dt"   value=""/>
                                        </div>
                                        <div class="col-md-6">
                                          <h5><b>Rental Closing Date: </b></h5>
                                          <input type="date" name="rental_cl_dt"   value=""/>
                                        </div>                                     
                                  </div>  
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          ...
                                          <input type="text" name="mon_amount"   value=""/>
                                        </div>
                                        <div class="col-md-6">
                                          <h5><b>Operator Helper Expense: <small>(optional)</small></b></h5>
                                          <input type="text" name="expense"   value=""/>
                                        </div>
                                  </div>    
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          ...
                                          <input type="text" name="maintenance"   value=""/>
                                        </div>
                                        <div class="col-md-6">
                                          <h5><b>Total Fuel Consumption: </b></h5>
                                          <input type="text" name="fuel_consum"   value=""/>
                                        </div>
                                  </div>  
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          ...
                                          <input type="text" name="first_workingday"   value=""/>
                                        </div>
                                        <div class="col-md-6">
                                          <h5><b>Closing Meter Reading: <small>(last working day of month)</small>  </b></h5>
                                          <input type="text" name="last_workingday"   value=""/>
                                        </div>
                                  </div> 
                                 ...
                                 <div class="row with-forms">                                      
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" name="running_hrs"   value=""/>
                                        </div> 
                                  </div>  
