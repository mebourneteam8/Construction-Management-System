...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 <!-- Basic Page Needs
 ================================================== -->
 <title><?=$this->user_model->sitename?> :  New Order </title>
 <meta charset="utf-8">
  ...
  ================================================== -->
    ...
    <div id="titlebar">
      <div class="col-md-10 col-md-offset-1">
          <h2><b> <i class="fa fa-edit"></i> New Order </b></h2>
          <!-- Breadcrumbs -->
          <nav id="breadcrumbs">
    ...
    <?=$this->session->flashdata('messagePr')?>
                    ...
                    <div class="add-listing-section">
                      ...
                      <div class="add-listing-headline">
                        <h3><i class="list-box-icon im im-icon-User"></i> New Order Details</h3>
                      </div>

                      <!-- Row -->
                      <form method="post" action="<?=base_url()?>admin/new_order_sub" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="row with-forms">                                
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" name="p_client" required  value=""/>
                                  </div>
                                  <div class="col-md-6">
                                    <h5><b>Secondery Client: *</b></h5>
                                    <input type="text" name="s_client" required  value=""/>
                                  </div>
                           </div>
                          ...
                          <div class="row with-forms">                                
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" name="work_type" required  value=""/>
                                  </div>
                                  <div class="col-md-6">
                                    <h5><b>Tender Value: *</b></h5>
                                    <input type="text" name="tender_value" required  value=""/>
                                  </div>
                           </div>
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          ...
                                          <input type="date" name="order_received" required  value=""/>
                                        </div>
                                        <div class="col-md-6">
                                          <h5><b>Order Number: *</b></h5>
                                          <input type="text" name="order_no" required  value=""/>
                                        </div>
                                  </div>                 
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          ...
                                          <input type="date" name="work_commence"   value=""/>
                                        </div>
                                        <div class="col-md-6">
                                          <h5><b>Project Handover Date: </b></h5>
                                          <input type="date" name="project_handover"   value=""/>
                                        </div>
                                  </div>  
                                 ...
                                 <div class="row with-forms">                                      
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <input type="date" name="ntp_received"   value=""/>
                                        </div>
                                  </div>    

                                 <div class="row with-forms">                                      
                                        <div class="col-md-6">
                                          <h5><b>Upload Order Copy: <small>(soft copy of order in pdf format)</small></b></h5>
                                        </div>
                                        <div class="col-md-6">
